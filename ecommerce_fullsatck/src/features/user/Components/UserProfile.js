...
// import { selectCompleteUser } from '../userSlice';

export default function UserProfile() {
  // const count = useSelector(selectCompleteUser);
  const {
    register,
    handleSubmit,
    watch,
          ...
          <div className="mx-auto mt-12 max-w-7xl bg-white px-4 sm:px-6 lg:px-8">
            <div>
              ...
              onClick={e=>{setShowAddAddressForm(true); setSelectedEditIndex(-1)}}
                type="submit"
                className="rounded-md bg-green-600 my-4 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Add New Address
              </button>
              ...
              {showAddAddressForm && (
                <div className=" py-4 ">
                <form
                  className="bg-green-300 px-5 py-3 mt-12"
                  noValidate
                      ...
                      <ul role="list" className="my-6">
                        <li className="flex justify-between gap-x-6 py-5 border-solid border-2 border-gray-200 px-5">
                          ...
                          <div className="hidden sm:flex sm:flex-col sm:items-end">
                            <button
                              onClick={(e) =>{ handleEditForm(index); setShowAddAddressForm(false)}}
                              type="button"
